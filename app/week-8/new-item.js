    ...
    <form onSubmit={handleSubmit} className="bg-gray-800 text-white p-5 rounded-md flex flex-col items-center">
      ...
      <div className="flex items-center justify-between w-full mb-4">
        <button
          ...
          className={`border-5 px-7 py-1 rounded-md ${
        ...
        <button
          ...
          className={`border-2 px-7 py-1 rounded-md ${
      ...
      <button type="submit" className="bg-blue-600 text-white px-6 py-2 rounded-md w-16">
  +
</button>
    </form>
  );
